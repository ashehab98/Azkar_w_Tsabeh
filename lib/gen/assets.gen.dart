...
class $AssetsImagesGen {
  ...
  AssetGenImage get logoAzkar => const AssetGenImage('assets/images/logoazkar.jpg');
  AssetGenImage get Sebha => const AssetGenImage('assets/images/sebha.jpg');
  AssetGenImage get Pluss => const AssetGenImage('assets/images/pluss.png');
  AssetGenImage get compass => const AssetGenImage('assets/images/compass.png');
  AssetGenImage get needle => const AssetGenImage('assets/images/needle.png');


  /// List of all assets
  List<AssetGenImage> get values =>
      [logo, potato, pubbles, sideImage, splashBg, visa,backGround,logoAzkar,Sebha,Pluss,needle,compass];
}
