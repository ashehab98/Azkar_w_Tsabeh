...
import 'package:seb7a/core/design/main_container.dart';

class AzkarSaba7View extends StatelessWidget {
  const AzkarSaba7View({super.key});
        ...
        body: ListView(
          children: [
            ...
            const MainContainer(
              ...
              text2: "من قالها حين يصبح أدى شكر يومه.",
              counter: 1,
              num: 9,
            ),
            Divider(thickness: 4, color: Colors.grey.withOpacity(.3)),
